...
test('Auto adds language code and file extension parameters if setting enabled', () => {
...
test('Does not conflict with other dot separated values when matching language code and file extension parameters', () => {
